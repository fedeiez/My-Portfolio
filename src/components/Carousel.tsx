...
export default function Carousel() : JSX.Element {
  ...
  <div id="slide1" className="carousel-item relative w-full ">
    <img
      ...
      src="./src/assets/workspace-with-note-brick-wall.jpg"
  ...
  <div id="slide2" className="carousel-item relative w-full">
    ...
    <div className="absolute inset-0 bg-linear-to-r from-black to-red-900 opacity-50"></div>
    <h1 className="absolute inset-0 flex items-center justify-center text-white text-5xl font-bold"> Iezzi Federica <br></br>Full Stack Web developer</h1>
    <div className="absolute left-5 right-5 top-1/2 flex -translate-y-1/2 transform justify-between">
  ...
  <div id="slide3" className="carousel-item relative w-full">
    <img
      alt="desk with-notebook"
      src="./src/assets/4443324.jpg"
      className="w-full object-cover object-center" />
    <div className="absolute inset-0 bg-linear-to-r from-black to-green-950 opacity-50"></div>
    <h1 className="absolute inset-0 flex items-center justify-center text-white text-5xl font-bold">Project Showcase</h1>
    <div className="absolute left-5 right-5 top-1/2 flex -translate-y-1/2 transform justify-between">
      <a href="#slide2" className="btn btn-circle">❮</a>
      <a href="#slide4" className="btn btn-circle">❯</a>
    </div>
